...
## 2024-09-08 - Waiter Rapid Entry Form Accessibility
**Learning:** Fast-paced POS interfaces often omit visible labels for space, breaking accessibility.
**Action:** Always add explicit aria-labels and aria-expanded attributes to inputs, textareas, and toggle buttons in waiter UI.
