...
## 2026-09-06 - WaiterOrderClient input and toggle accessibility
**Learning:** In Waiter UI forms, using placeholders alone is not sufficient for screen readers; aria-labels are essential for inputs (including select/textarea), and toggle buttons require aria-expanded.
**Action:** Always add aria-expanded to collapsible sections and explicit aria-label to all inputs and textareas that lack visible labels.
