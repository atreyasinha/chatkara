...
## 2024-09-11 - Explicit ARIA Labels in POS
**Learning:** Standalone rapid-entry inputs and icon-only modifiers in POS components often lack context for screen readers.
**Action:** Always explicitly add aria-label attributes to these elements.
