...
## 2026-09-20 - Explicit ARIA Labels in Rapid-Entry UIs
**Learning:** POS interfaces prioritize compactness by omitting visual labels, making explicit ARIA labels on standalone inputs and icon modifiers critical for accessibility.
**Action:** Always add aria-labels to unlabelled inputs and icon buttons in high-density components.
