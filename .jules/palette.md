...
## 2024-08-11 - Adding `aria-expanded` to Collapsible Buttons
**Learning:** Collapsible sections and accordions need to convey their state to screen readers, allowing users to know if clicking the button will show or hide content.
**Action:** When creating a button that toggles visibility of adjacent or wrapped content, always apply the `aria-expanded={isOpen}` attribute.
