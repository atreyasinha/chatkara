...
export async function POST(request: Request) {
  // Always verify webhook secret BEFORE parsing the request body to prevent JSON parsing DoS
  // and NEVER use unverified payload data (e.g. callback_query.id) for SSRF/API spoofing.
