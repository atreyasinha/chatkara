...
import { useMemo, useState, useDeferredValue, useCallback, memo } from "react";
...
export function WaiterOrderClient() {
  ...
  // ⚡ Bolt: O(1) map lookup for cart items during render
...
// ⚡ Bolt: Memoized independent component to prevent list re-renders
