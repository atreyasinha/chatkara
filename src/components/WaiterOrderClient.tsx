...
export function WaiterOrderClient() {
  ...
  // ⚡ Bolt: Defer expensive search filtering to keep the input instantly responsive
  ...
  // ⚡ Bolt: Optimize cart lookups from O(N) array search inside .map() to O(1) Map lookup
...
// ⚡ Bolt: Memoize individual list rows so that modifying one item's cart quantity
// doesn't cause the entire menu list to re-render.
